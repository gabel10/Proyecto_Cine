                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i></i> Lista Carteleras</h3>
                        </div>
                        <div class="panel-body">
                            <a type="button" class="btn btn-success btn-lg" href="agregar_cartelera.htm"> + Agregar Cartelera</a><br><br>
                                    ...
                                    <tbody>
                                        <c:forEach items="${datos}" var="dato">
                                            <tr>
                                                ...
                                                <td>${dato.get("fecha_cartelera")}</td>
                                                <td>
