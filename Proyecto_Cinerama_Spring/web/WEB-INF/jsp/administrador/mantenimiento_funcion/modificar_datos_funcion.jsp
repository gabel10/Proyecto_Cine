            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        ...
                        <label>Horario : ${datos.getHorario()}</label><br>                       
                        <label>Id_Pelicula : ${datos.getId_pelicula()}</label><br>                        
                        <label>Id_Sala : ${datos.getId_sala()}</label><br>                         
                          
                        <a type="button" class="btn btn-success btn-lg" href="index_funciones.htm">Aceptar</a><br><br>
