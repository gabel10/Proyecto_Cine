                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">                            
                            <div class="row">   
                                <form action="guardar_datos_sala.htm" method="POST">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Numero de asientos" name="nro_asientos">

                                        </div> 
                                        
                                        <div class="form-group">
                                            <label>Asientos</label>
                                            <input class="form-control" id="asientos" placeholder="Cadena de Asientos" name="asientos">
                                            <div class="form-group"></div>
                                            <button type="button" class="btn btn-success btn-md" onclick="crearSala()">Generar Asientos</button>           
                                        </div> 
