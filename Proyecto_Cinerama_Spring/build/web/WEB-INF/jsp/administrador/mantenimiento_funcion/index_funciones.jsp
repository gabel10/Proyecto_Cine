    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i></i> Lista de Funciones</h3>
                        </div>
                        <div class="panel-body">
                            <a type="button" class="btn btn-success btn-lg" href="agregar_funcion.htm"> + Agregar Funcion</a><br><br>
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${datos}" var="dato">
                                            <tr>
                                                <td>${dato.get("_id")}</td>
                                                <td>${dato.get("horario")}</td>
                                                <td>${dato.get("id_pelicula")}</td>
                                                <td>${dato.get("id_sala")}</td>
        ...
        <script>
            ...
            function fnEditar(comp){
                 location.href="modificar_funcion.htm?id="+comp.id;
            }
            function fnverDetalles(comp){
                 location.href="detalle_funcion.htm?id="+comp.id;
            }
        </script>
