...
<html>
    <head>
        ...
        <!-- Custom CSS -->
        <link href="<c:url value="recursos/css/sb-admin.css"/>" rel="stylesheet">
        <!-- Morris Charts CSS -->
        <link href="<c:url value="recursos/css/plugins/morris.css"/>" rel="stylesheet">
        <!-- Custom Fonts -->
        <link href="<c:url value="recursoso/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet" type="text/css">
        <link type="image/x-icon" rel="shortcut icon" href="<c:url value="recursos/images/favicon.png" />">
        <script language="javascript" src="<c:url value="recursos/js/motor.js" />"></script>
        <script language="javascript" src="<c:url value="recursos/js/cargaimagen.js"/>"></script>
    </head>
    <body onload="javascript:Carga('estadisticas.jsp','contenido')">
        <div id="wrapper">
        <!-- Navigation -->
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="../bienvenido.html"><i class="fa fa-fw fa-user"></i> Perfil</a>
                        </li>
                        <li>
                ...
                <div id="contenido">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <small>Vista de Estadísticas</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>kon la leyecda jamas contado peloculas numero 25</td>
                                                <td>10/21/2013</td>
                                                <td>3:29 PM</td>
                                                <td>$321.33</td>
                                            </tr>
